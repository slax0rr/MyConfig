...
plugins=(git git-extras colorize colored-man-pages composer compleat debian docker-compose docker golang pip tmux vagrant jira web-search isup gpg-agent)
