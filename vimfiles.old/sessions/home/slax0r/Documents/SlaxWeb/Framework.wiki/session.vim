...
nmap \tb :TagbarToggle
nmap \pd :Pdoc <cword>
map \sd :setlocal nospell
map \se :setlocal spell spelllang=en_gb
map \nt :NERDTree
...
nnoremap <silent> <SNR>63_QAToolsToggle :call Phpqa#QAToolsToggle()
nnoremap <silent> <SNR>63_CodeCoverageToggle :call Phpqa#CodeCoverageToggle()
...
silent only
cd ~/Documents/SlaxWeb/Framework.wiki
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +24 Documentation.md
badd +28 Home.md
argglobal
silent! argdel *
...
setlocal tabstop=4
setlocal tagcase=
setlocal tags=~/Documents/SlaxWeb/Framework.wiki/.git/tags,.tags;
...
setlocal tabstop=4
setlocal tagcase=
setlocal tags=~/Documents/SlaxWeb/Framework.wiki/.git/markdown.tags,~/Documents/SlaxWeb/Framework.wiki/.git/tags,.tags;
setlocal textwidth=0
setlocal thesaurus=
setlocal noundofile
setlocal undolevels=-123456
