...
nnoremap <silent> <SNR>62_QAToolsToggle :call Phpqa#QAToolsToggle()
nnoremap <silent> <SNR>62_CodeCoverageToggle :call Phpqa#CodeCoverageToggle()
...
silent only
cd ~/GDrive/SlaxWeb/Documentation
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 gdrive:/0BzdSNrNIyFK5cmFoNEtCWVY2eDA/0BzdSNrNIyFK5emJ5NTVIbW9VUUk/0BzdSNrNIyFK5ckFRUzloWTVVcUE
argglobal
silent! argdel *
...
argglobal
enew
file gdrive:/0BzdSNrNIyFK5cmFoNEtCWVY2eDA/0BzdSNrNIyFK5emJ5NTVIbW9VUUk/0BzdSNrNIyFK5ckFRUzloWTVVcUE
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
