...
set laststatus=2
set mouse=a
set runtimepath=~/.vim,~/.vim/bundle/doc,~/.vim/bundle/plugin,~/.vim/bundle/syntastic,~/.vim/bundle/vim-gitgutter,~/.vim/bundle/vim-indent-guides,~/.vim/bundle/Vundle.vim,~/.vim/bundle/vim-phpqa,~/.vim/bundle/vdebug,/usr/local/share/vim/vimfiles,/usr/local/share/vim/vim74,/usr/local/share/vim/vimfiles/after,~/.vim/after,~/.vim/bundle/Vundle.vim/after,~/.vim/bundle/vim-gitgutter/after,~/.vim/bundle/vim-phpqa/after,~/.vim/bundle/vdebug/after
set shiftwidth=4
...
silent only
cd ~/Development/vagrant/dev/leshop.dev
...
silent! normal! zE
let s:l = 40 - ((39 * winheight(0) + 36) / 73)
